...
def times100():
    ...
    time_average = np.mean(time_array)
    print("Середній час виконання 100 разів роботи програми:")
    print("--- %s seconds ---" % (time_average))
