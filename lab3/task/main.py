...
print("Використаємо scipy для пошуку коефіцієнтів для статистичних перевірок.")
print("Маємо:")
print("Коефіцієнт Кохрена: ", G_kr)
print("Коефіцієнт Стьюдента: ", t_student)
print("Коефіцієнт Фішера: ", ft)
